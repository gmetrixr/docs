...
<!-- TODO: The app that was used in the following FAQ does not exist anymore. -->
<!-- ## How to capture 360 images using a mobile phone?

[Cardboard Camera](https://play.google.com/store/apps/details?id=com.google.vr.cyclops&hl=en_IN/) is a mobile app that can capture 360 images compatible with the GMetri Editor. 
...
![captured photo](https://r.vrgmetri.com/image/q_90/gb-web/portal-docs/assets/img/screenshots/foto_no_exit.jpg#boxShadow "captured photo")
...
![converted photo](https://r.vrgmetri.com/image/q_90/gb-web/portal-docs/assets/img/screenshots/foto_no_exit_converted.jpg#boxShadow "converted photo")
...
![photo](https://s.vrgmetri.com/gb-web/portal-docs/assets/img/screenshots/foto.JPG#boxShadow "photo")  -->
